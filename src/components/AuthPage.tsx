        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 rounded-2xl max-w-sm w-full p-6 shadow-2xl relative border border-slate-100 dark:border-slate-800">
            ...
            <div className="text-center mb-6">
              ...
              <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-100">Choose an account</h3>
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">to continue to BIR Compliance Monitor</p>
            </div>
                        ...
                        <div className="flex items-center space-x-1 flex-shrink-0 ml-2">
                          {isSigningIn ? (
                            ...
                            <button
                              ...
                              className="p-1 text-slate-300 dark:text-slate-500 hover:text-red-500 rounded-lg hover:bg-red-50 dark:hover:bg-red-950/40 transition-colors opacity-0 group-hover:opacity-100"
